            ...
            <div className={classes.root}>
                <div className="card">
                    ...
                    <div className="card-body">
                        <div>Which of the following is a reference type in C#?</div><br />
                        <div className="input-group mb-3 input-group-lg">
                            ...
                            <label for="radio1" className="form-control test-option">String</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio2" className="form-control test-option">
                                Long</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
...
export default withStyles(styles)(connect(mapStateToProps, matchDispatchToProps)(Question3));