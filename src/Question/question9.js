    ...
    render(){
        ...
        return (
            <div className={classes.root}>
                <div className="card">
                    <div className="card-header">Question#: 9</div>
                    <div className="card-body">
                        <div>String data type is ______.</div><br />
                        <div className="input-group mb-3 input-group-lg">
                            ...
                            <label for="radio1" className="form-control test-option">Mutable</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio2" className="form-control test-option">Immutable</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio3" className="form-control test-option">Static</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio4" className="form-control test-option">Value type</label><br />
                        </div>
                    </div>
...
export default withStyles(styles)(connect(mapStateToProps, matchDispatchToProps)(Question9));