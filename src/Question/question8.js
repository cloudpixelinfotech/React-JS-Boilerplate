    ...
    render(){
        ...
        return (
            <div className={classes.root}>
                <div className="card">
                    <div className="card-header">Question#: 8</div>
                    <div className="card-body">
                        <div>What is indexer?</div><br />
                        <div className="input-group mb-3 input-group-lg">
                            ...
                            <label for="radio1" className="form-control test-option">It allows an instance of a class to be indexed like an array</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio2" className="form-control test-option">It allows enumerator with class</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio3" className="form-control test-option">It creates index for instances of a class.</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
...
export default withStyles(styles)(connect(mapStateToProps, matchDispatchToProps)(Question8));