                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="input-group mb-3 input-group-lg">
                            ...
                            <label for="radio1" className="form-control test-option">Reference type</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio2" className="form-control test-option">Value type</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio3" className="form-control test-option">Class type</label><br />
                        </div>
                        <div className="input-group mb-3 input-group-lg">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                            ...
                            <label for="radio4" className="form-control test-option">String type</label><br />
                        </div>
                    </div>
...
export default withStyles(styles)(connect(mapStateToProps, matchDispatchToProps)(Question5));